...
дополнительного опроса движков не нужно. (При балансировке канал выбирался бы
роутером на каждое соединение, и посчитать отдачу по каналам со стороны движка было
